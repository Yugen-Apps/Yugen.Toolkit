...
namespace Yugen.Toolkit.Uwp.Helpers
{
    ...
    public static class TitleBarHelper
    {
        ...
        /// </summary>
        public static void StyleTitleBar(Color buttonForegroundColor, Color buttonHoverBackgroundColor, Color buttonHoverForegroundColor, Color buttonInactiveForegroundColor)
        {
