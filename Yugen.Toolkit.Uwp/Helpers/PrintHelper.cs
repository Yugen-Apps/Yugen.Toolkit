...
namespace Yugen.Toolkit.Uwp.Helpers
{
    ...
    public class PrintHelper : IDisposable
    {
        ...
        /// </summary>
        public double ApplicationContentMarginLeft { get; set; }

        /// <summary>
        /// Gets or sets the percent of app's margin height
        /// </summary>
        public double ApplicationContentMarginTop { get; set; }
        ...
        /// <param name="applicationContentMarginLeft"></param>
        /// <param name="applicationContentMarginTop"></param>
        public PrintHelper(Panel canvasContainer, double applicationContentMarginLeft = 0.03, double applicationContentMarginTop =0.03)
        {
            ApplicationContentMarginLeft = applicationContentMarginLeft;
            ApplicationContentMarginTop = applicationContentMarginTop;
            
            _printPreviewPages = new List<FrameworkElement>();
            _printCanvas = new Canvas {Opacity = 0};
        ...
        private void CreatePrintPreviewPages(object sender, PaginateEventArgs e)
        {
            ...
            if (_directPrint)
            {
                foreach (FrameworkElement element in _canvasContainer.Children)
        ...
        private void AddPrintPages(object sender, AddPagesEventArgs e)
        {
            ...
            foreach (FrameworkElement t in _printPreviewPages)
                // We should have all pages ready at this point...
                _printDocument.AddPage(t);
